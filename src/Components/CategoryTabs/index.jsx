          ...
          {allTypes.map((items) => (
            <Link to={`/${items.id}`} key={items.id} className="w-1/4">
              <div
                className={
                  type === items.id
                    ? "flex flex-col items-center text-xl text-main-400"
              ...
              >
                <div
                  className={
                    type === items.id
                      ? "flex justify-center items-center flex-col w-full py-3 border-t-2 border-main-400"
            ...
            <Link to={`/${items.id}`} key={items.id}>
              <div
                className={classnames(
                  ...
                  { "border-b-2 border-main-400": type === items.id }
                )}
              >
                <div
                  className={classnames(
